### Reference Code for the CFCOS Demo Simulation
...
By default, the backend server can be launched with `python ./main.py`, and the Node.js server can be started using `npm start`.
However, additional configuration (e.g., API keys and other missing credentials) is required to run the system fully.
